...
class AIPlayer: public Player{
    ...
    public:
        ...
        void thinkAleatorioMasInteligete(color & c_piece, int & id_piece, int & dice) const;

        void thinkFichasMasAdelante(color & c_piece, int & id_piece, int & dice) const;
        ...
        /**
         * @brief Heurística para algoritmo de búsqueda
         * 
         * @param estado Instancia de Parchis con el estado actual de la partida.
         * @param jugador Id del jugador actual (0 o 1)
         * @return double 
